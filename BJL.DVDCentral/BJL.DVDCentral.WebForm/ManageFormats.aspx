...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-row ml-1 mt-2">
        <div class="control-label col-md-2">
            <asp:Label ID="Label1" runat="server" Text="Formats:"></asp:Label>
        </div>
        <div class="control-label col-md-3">
            <asp:DropDownList ID="ddlFormats" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlFormats_SelectedIndexChanged">
            </asp:DropDownList>
        </div>
    </div>
    ...
    <div class="form-row ml-1 mt-2">
        ...
        <div class="control-label col-md-3">
            <asp:TextBox ID="txtFormatDescription" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
