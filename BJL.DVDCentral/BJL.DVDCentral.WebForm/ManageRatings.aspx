...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-row ml-1 mt-2">
        ...
        <div class="control-label col-md-3">
            <asp:DropDownList ID="ddlRatings" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlRatings_SelectedIndexChanged">
            </asp:DropDownList>
        </div>
    </div>
    ...
    <div class="form-row ml-1 mt-2">
        ...
        <div class="control-label col-md-3">
            <asp:TextBox ID="txtRatingDescription" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
